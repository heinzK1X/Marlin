...
#define DELTA_PRINTABLE_RADIUS 60  // must be int, not float, to make auto_bed_level work
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 395  // For delta: Distance between nozzle and print surface after homing.
#endif
